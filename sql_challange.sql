...
INNER JOIN departments AS d ON (d.dept_no = de.dept_no) AND (d.dept_name='Sales');
...
FROM employees AS e 
INNER JOIN dept_emp AS de ON (de.emp_no = e.emp_no)
INNER JOIN departments AS d ON (d.dept_no = de.dept_no) AND (d.dept_name='Sales') OR (d.dept_name='Development')
